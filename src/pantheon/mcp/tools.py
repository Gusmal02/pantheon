...
def enrich_hypothesis(source_ips: list[str], hours: float = 2.0) -> str:
    """Enriquece una hipótesis con contexto de conectores activos.

    Llamada por Hermes durante la fase de investigación. Retorna texto
    con evidencia de Suricata y/o Wazuh sobre las IPs implicadas.
    No lanza excepciones — retorna string vacío si no hay conectores o datos.
    """
    parts: list[str] = []
